            ...
            <?php
              class Account {
                ...
                public function cetak(){
                    ...
                    $cs1 = new Account ('Nasrullah','C011', 7900000);
                    $cs1 -> deposit(4200000);
                    $cs1 -> cetak(); 
                    echo "Nasrullah Menabung Uang Sebesar Rp 7.900.000";

                    echo "</br>";
                    $cs2 = new Account ('Anni', 'C012', 5350000);
                    $cs2 -> withdraw(2500000);
                    $cs2 -> cetak();
                    echo "Anni Menarik Uang Sebesar Rp. 2.500.000";

                    echo "</br>";
                    $cs3 = new Account ('Bintang', 'C013',3500000);
                    $cs3 -> cetak();
                ?>
            </div>
          </div>
